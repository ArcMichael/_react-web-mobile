...
import SingeDoor, { singleCoupon } from "./singeDoor";
...
const DoorCoupon: React.FunctionComponent<CouponBodyProps> = ({
  isBottom,
  getMyCoupon,
  nowValid,
               ...
               {nowValid === 1 ? (
                  <div className="discount-body-hasDiscount-tip">
                    <span
                      onClick={() => {
                        window.location.href =
                          "/v2/html/myAccountHistoryCoupon?isDoor=1";
                      }}
                    >
                      历史优惠券
                    </span>
...
export default ScrollContainer<CouponBodyProps, typeof DoorCoupon>(DoorCoupon);
