 ...
 */
export default class ShoppingCartOutlined extends React.Component {
  render() {
    ...
    return (
      <span style={{ display: "inline-block", width: "1em", height: "1em", fontSize: size }}>
        <svg width="1em" height="1em" fill={color} viewBox="0 0 32 32">
          <path d="M21.453 12c0.503 0 0.928 0.374 0.992 0.873l1.41 11c0.070 0.548-0.317 1.049-0.865 1.119-0.042 0.005-0.085 0.008-0.127 0.008h-13.727c-0.552 0-1-0.448-1-1 0-0.043 0.003-0.085 0.008-0.127l1.41-11c0.064-0.499 0.489-0.873 0.992-0.873h10.907zM20.925 13.6h-9.851l-1.256 9.8h12.363l-1.256-9.8z" />
