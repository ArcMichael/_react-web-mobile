...
class ProvincialAndUrbanAreas extends React.Component {
  ...
  renderProvinceData(data) {
    return (
      ...
      data.map((item, index) => (
        <li
          onClick={this.clickProvince.bind(this, item)}
          key={`my_address_province_province_${index}`}
        >
          {item.provinceName}
        </li>
      ))
    ...
    return (
      ...
      data.map((item, index) => (
        <li
          ...
          key={`my_address_province_city_${index}`}
        >
          {item.cityName}
        </li>
      ))
  ...
  renderAreaData(data) {
    ...
    return (
      ...
      data.map((item, index) => (
        <li
          onClick={this.clickArea.bind(this, item)}
          key={`my_address_province_area_${index}`}
        >
          {item.districtName}
        </li>
      ))
  ...
  render() {
    ...
    return (
      <div className="my_address_province">
        ...
        {
          <ul
            className={`my_address_province_city ${isCity ? "cityActive" : ""}`}
          >
        ...
        {
          <ul
            className={`my_address_province_area ${isArea ? "areaActive" : ""}`}
          >
